...
public class Encuesta {
    ...
    public void rellenarEncuesta(Paciente paciente){
        ...
        paciente.getDia1().getDesayuno().addAlimento(new Alimento("Manzana", 52, 0.26, 0.17, 13.81, 0.0003, 0.003));
        paciente.getDia1().getDesayuno().addAlimento(new Alimento("Platano", 89, 1.09, 0.33, 22.84, 0.0004, 0.004));

        paciente.getDia1().getAlmuerzo().addAlimento(new Alimento("Arroz", 130, 2.7, 0.28, 28.17, 0.0001, 0.001));
        paciente.getDia1().getAlmuerzo().addAlimento(new Alimento("Pollo", 239, 27.3, 14.7, 0, 0.0001, 0.001));

        paciente.getDia1().getComida().addAlimento(new Alimento("Pasta", 131, 5.47, 0.54, 25.77, 0.0001, 0.001));
        paciente.getDia1().getComida().addAlimento(new Alimento("Carne", 250, 26.7, 15.3, 0, 0.0001, 0.001));

        paciente.getDia1().getMerienda().addAlimento(new Alimento("Leche", 42, 3.37, 1.03, 4.8, 0.0001, 0.001));
        paciente.getDia1().getMerienda().addAlimento(new Alimento("Galletas", 502, 6.7, 24.3, 66.7, 0.0001, 0.001));

        paciente.getDia1().getCena().addAlimento(new Alimento("Pescado", 206, 20.5, 13.6, 0, 0.0001, 0.001));


        paciente.getDia2().getDesayuno().addAlimento(new Alimento("Manzana", 52, 0.26, 0.17, 13.81, 0.0003, 0.003));
        paciente.getDia2().getDesayuno().addAlimento(new Alimento("Platano", 89, 1.09, 0.33, 22.84, 0.0004, 0.004));

        paciente.getDia2().getAlmuerzo().addAlimento(new Alimento("Sandwich", 250, 12.5, 10.5, 25, 0.0001, 0.001));
        paciente.getDia2().getAlmuerzo().addAlimento(new Alimento("Zumo de Naranja", 46, 0.5, 0.1, 11.1, 0.0001, 0.001));

        paciente.getDia2().getComida().addAlimento(new Alimento("Ensalada", 15, 1.5, 0.5, 2.5, 0.0001, 0.001));

        paciente.getDia2().getMerienda().addAlimento(new Alimento("Jamón Serrano", 191, 30.5, 7.5, 0, 0.0001, 0.001));

        paciente.getDia2().getCena().addAlimento(new Alimento("Pescado", 206, 20.5, 13.6, 0, 0.0001, 0.001));


        paciente.getDia3().getDesayuno().addAlimento(new Alimento("Cafe", 1, 0.1, 0, 0.3, 0.0001, 0.001));

        paciente.getDia3().getComida().addAlimento(new Alimento("Pasta", 131, 5.47, 0.54, 25.77, 0.0001, 0.001));
        
        paciente.getDia3().getMerienda().addAlimento(new Alimento("Yogurt", 150, 8, 4, 15, 0.0002, 0.002));
        paciente.getDia3().getMerienda().addAlimento(new Alimento("Nueces", 196, 4, 19, 3, 0.0003, 0.003));
    
        paciente.getDia3().getCena().addAlimento(new Alimento("Sopa de Verduras", 120, 2, 1.5, 15, 0.0001, 0.001));
        paciente.getDia3().getCena().addAlimento(new Alimento("Tofu", 144, 16, 8, 2, 0.0002, 0.002));


        paciente.getDia4().getAlmuerzo().addAlimento(new Alimento("Pasta con Salsa de Tomate", 200, 5, 2, 40, 0.0001, 0.001));
        paciente.getDia4().getAlmuerzo().addAlimento(new Alimento("Ensalada de Pollo", 180, 20, 10, 5, 0.0001, 0.001));
    
        paciente.getDia4().getComida().addAlimento(new Alimento("Ensalada", 15, 1.5, 0.5, 2.5, 0.0001, 0.001));

        paciente.getDia4().getMerienda().addAlimento(new Alimento("Frutas Mixtas", 120, 2, 1, 25, 0.0002, 0.002));
    
        paciente.getDia4().getCena().addAlimento(new Alimento("Salmón a la Parrilla", 250, 25, 15, 0, 0.0002, 0.002));


        paciente.getDia5().getDesayuno().addAlimento(new Alimento("Cereal Integral", 120, 3, 1, 25, 0.0002, 0.002));
        paciente.getDia5().getDesayuno().addAlimento(new Alimento("Leche de Almendra", 60, 2, 1, 8, 0.0001, 0.001));
    
        paciente.getDia5().getComida().addAlimento(new Alimento("Hamburguesa de Pavo", 300, 30, 15, 0, 0.0002, 0.002));
        paciente.getDia5().getComida().addAlimento(new Alimento("Quinoa", 150, 5, 2, 25, 0.0002, 0.002));
    
        paciente.getDia5().getCena().addAlimento(new Alimento("Ensalada de Atún", 180, 15, 8, 5, 0.0001, 0.001));
        paciente.getDia5().getCena().addAlimento(new Alimento("Batata Asada", 120, 2, 0.5, 26, 0.0001, 0.001));
    }
